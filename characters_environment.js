...
function play(){
gamestatus="start"
document.getElementById("status").innerHTML="Starting The Game..."
}
function game(){
console.log("Nose X="+noseX+"nose Y="+noseY)
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Click on Play Button To Start ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function changeGameStatud(character){
  if(noseY != "" && gamestatus=="start"&& gameConfig.status==="start") {
    world_start.play();
